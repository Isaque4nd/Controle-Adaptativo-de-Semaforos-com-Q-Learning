...
SUMO_CFG_FILE = "BrumadoxRPacheco\\BrumadoxRPacheco.sumocfg"
TRAFFIC_LIGHT_ID = "2078773993"
...
def train():
    ...
    for ep in range(EPOCHS):
        ...
        if avg_reward > best_reward_avg:
            ...
            with open("q_table_brumado.pkl", "wb") as f: pickle.dump(dict(q_table), f)
